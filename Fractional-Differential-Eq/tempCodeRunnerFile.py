...
# Plot the Lorenz attractor with interpolation
fig2 = plt.figure(figsize=(8, 6))
ax2 = fig2.add_subplot(111, projection='3d')
ax2.plot(interp_xyz[:, 0], interp_xyz[:, 1], interp_xyz[:, 2], lw=0.5, color='blue')
ax2.set_xlabel('x(t)')
ax2.set_ylabel('y(t)')
ax2.set_zlabel('z(t)')
ax2.set_title('Lorenz Attractor (With Interpolation)')
